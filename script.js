    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "נאור פרסום ומדיה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '5e079661-96b3-4fad-a0ee-429d8a2c121a',
                    name: data.name || '',
                    email: data.email || '',
